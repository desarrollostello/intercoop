<?php $__env->startSection('content'); ?>
    <div class="container row" style="min-height: 70vh;">
        ...
        <div class="col s12 l8" id="timeline-content">
            <h5>Recent activity</h5>
            <section id="my-timeline" class="articles-feed">
                        ...
                        <article class="my-timeline-block margin-t z-depth-1" data-article="<?php echo e(Hashids::encode($feed->feed_id)); ?>">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <p class="mpadding-tb"><?php echo trans('home_page.uploadded_new_photo',['user_name'=>$feed->user_name]); ?></p>
            ...
            <div id="feed-content-spinner" class="spinner no-margin padding col s12 white z-depth-1" style="display:none;">
                <div class="small bounce1 light-blue lighten-1"></div>
                <div class="small bounce2 light-blue lighten-1"></div>
                <div class="small bounce3 light-blue lighten-1"></div>
            </div>
        </div>
        <?php /*<div class="col l3 hide-on-med-and-down margin-t recomended-users" style="position:relative;">
            <div class="white border-thin">
                <h6 class="center">Publicidad</h6>
                <p class="padding-lr">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.<br> Quas, autem, illo reiciendis asperiores beatae temporibus dignissimos veritatis ratione. Repellendus, modi ea iste molestiae vel dicta corrupti. Dolorum rerum quidem qui!
                </p>
                <div class="center">
