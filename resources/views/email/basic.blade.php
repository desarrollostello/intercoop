		...
		<td class="header container"  style="width: 100%;">
				...
				<table bgcolor="#29b6f6">
					<tr>
						<td>
                            <a href="{{ url('/') }}">
                                <img src="{{ url('img/logo-2.png') }}" alt="" width="35" style="display: inline-block;vertical-align: middle;"/> <h2 class="collapse" style="color: white;display: inline-block;vertical-align: middle;">{{ env('APP_NAME') }}</h2>
                            </a>
                        </td>
					</tr>
				</table>
			...
			<table width="100%">
				<tr>
					<td>
						...
						<p>
                            <a href="{{ url('/auth/activate?hash='.$hash.'&key='.$key_id) }}" style="padding: 2.5px 5px;">Activate!</a>
                        </p>
						<!-- Callout Panel -->
