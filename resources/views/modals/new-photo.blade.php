    ...
    <div class="chage-lang-modal row">
        <div class="row">
            ...
            <div class="col s12 no-padding">
                {!! Form::open(['route'=>'postphoto','class'=>'col s12 no-padding new-photo','onsubmit'=>'return false','files'=>'true']) !!}
                <div class="row">
                    <div class="post-avatar padding col m2 hide-on-small-only">
                        <img src="{{ asset(Auth::user()->profile->avatar->small) }}" alt="avatar" class="responsive-img circle profile-avatar-small" style="max-height: 100%;">
                    </div>
