...
@section('content')
    <div class="container row" style="min-height: 70vh;">
                        ...
                        <article class="my-timeline-block margin-t z-depth-1" data-article="{{ Hashids::encode($feed->feed_id) }}">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <p class="mpadding-tb">{!! trans('home_page.uploadded_new_photo',['user_name'=>$feed->user_name]) !!}</p>
        ...
        {{--<div class="col l3 hide-on-med-and-down margin-t recomended-users" style="position:relative;">
