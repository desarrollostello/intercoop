        ...
        <div class="mn-content fixed-sidebar">
                    ...
                    <div class="nav-wrapper row">
                        ...
                        <div class="col s3 m3">
                            <a href="{{ route('home-admin') }}">
                                <span class="chapter-title">{{ env('APP_NAME', APP_NAME) }}</span>
                            </a>
                        </div>
                        ...
                        <div class="col s12 m4 search-result-container">
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="/images/profile-image-1.png" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="/images/profile-image-3.jpg" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="/images/profile-image.png" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                    ...
                    <div id="sidebar-chat-tab" class="col s12 sidebar-messages right-sidebar-panel">
                        ...
                        <div class="chat-list">
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src="/images/profile-image-1.png" class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
                            ...
                            <a href="javascript:void(0)" class="chat-message">
                                <div class="chat-item">
                                    <div class="chat-item-image">
                                        <img src="/images/profile-image-3.jpg" class="circle" alt="">
                                    </div>
                                    <div class="chat-item-info">
            ...
            <aside id="chat-messages" class="side-nav white">
                ...
                <div class="messages-container">
                    <div class="message-wrapper them">
                        <div class="circle-wrapper"><img src="/images/profile-image-1.png" class="circle" alt=""></div>
                        <div class="text-wrapper">Lorem Ipsum</div>
                    </div>
                    <div class="message-wrapper me">
                        <div class="circle-wrapper"><img src="/images/profile-image-3.jpg" class="circle" alt=""></div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                    ...
                    <div class="sidebar-profile">
                        ...
                        <div class="sidebar-profile-info">
                            <a href="javascript:void(0);" class="account-settings-link">
                                <p class="truncate" style="width: 85%;display: inline-block;">
                                    {{ Auth::user()->first_name." ".Auth::user()->last_name }}
                                </p>
                                <span style="width: 12%;display: inline-block;">{{ Auth::user()->email }}<i class="icon-caret-down"></i></span>
                            </a>
                        </div>
                    </div>
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a href="{{ route('users-admin') }}" class="waves-effect waves-grey">
            ...
            <main class="mn-inner inner-active-sidebar">
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="stats-counter"><span class="counter">{{ \Pheaks\User::count() }}</span><small>This week</small></span>
                            </div>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                <div class="card-options">
                                    <ul>
                                        <li class="icon-picture"><!--<a href="javascript:void(0)"><i class="material-icons">more_vert</i></a>--></li>
                                    </ul>
                                </div>
                                <span class="card-title">Photos</span>
                                <span class="stats-counter"><span class="counter">{{ \Pheaks\Photo::where('status','1')->count() }}</span><small>Active photos</small></span>
                            </div>
                ...
                <div class="inner-sidebar">
                    ...
                    <div class="info-item message-item"><img class="circle" src="/images/profile-image-2.png" alt=""><div class="message-info"><div class="message-author">Ned Flanders</div><small>3 hours ago</small></div></div>
                    <div class="info-item message-item"><img class="circle" src="/images/profile-image.png" alt=""><div class="message-info"><div class="message-author">Peter Griffin</div><small>4 hours ago</small></div></div>
                    <div class="info-item message-item"><img class="circle" src="/images/profile-image-1.png" alt=""><div class="message-info"><div class="message-author">Lisa Simpson</div><small>2 days ago</small></div></div>
                    </div>
