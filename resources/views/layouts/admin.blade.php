        ...
        <nav class="light-blue lighten-1">
            <div class="nav-wrapper row">
                ...
                <ul class="right col s9 m3 nav-right-menu">
                    <li><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right show-on-large"><i class="material-icons">notifications</i><span class="badge">4</span></a></li>
                    <!--<li><a href="javascript:void(0)" class="search-toggle"><i class="material-icons">search</i></a></li>-->
                </ul>
